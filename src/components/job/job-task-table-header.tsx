...
export function JobTaskTableHeader() {
  return (
    <div className="-mx-4 px-4 lg:mx-0 lg:px-0">
      <Table className="sticky top-0 bg-white z-100 min-w-[900px] lg:min-w-full ">
        <TableHeader>
          <TableRow>
            <TableHead className="sticky left-0 z-20 bg-white w-2 sm:w-4 px-1 sm:px-2"></TableHead>
            <TableHead className="sticky left-2 z-20 bg-white w-22 sm:w-32 lg:w-48 xl:w-64 text-gray-600 text-xs after:absolute after:right-0 after:top-0 after:bottom-0 after:w-px after:bg-gray-200">
              Name
            </TableHead>
