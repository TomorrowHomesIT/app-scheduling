...
export const suppliers: ISupplier[] = [
  { id: 1, name: "Wall Frame Co.", color: "#3b82f6" },
  { id: 2, name: "Truss Pro Inc.", color: "#10b981" },
  { id: 3, name: "Window Experts", color: "#f59e0b" },
  { id: 4, name: "Mixer Masters", color: "#ef4444" },
  { id: 5, name: "Brick Supply Ltd.", color: "#8b5cf6" },
