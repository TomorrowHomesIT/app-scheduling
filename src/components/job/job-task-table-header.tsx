      ...
      <Table className="sticky top-0 bg-white z-100">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="sticky left-4 z-20 bg-white w-32 lg:w-64 text-gray-600 text-xs after:absolute after:right-0 after:top-0 after:bottom-0 after:w-px after:bg-gray-200">
              Name
            </TableHead>
